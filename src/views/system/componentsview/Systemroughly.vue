    ...
    <div class="roughly" style="overflow:hidden;">
        <div class="roughly_top">
            <div class="roughly_top_border">
                <b>年份 :</b>
                <el-select v-model="values" size="small" placeholder="请选择年份" style="width:10%;margin:0 10px;" @change="sel">
                    <el-option
                ...
                <b>号码 :</b>
                <el-input v-model="input" size="small" placeholder="请输入内容" style="width:30%;margin:10px;"></el-input>
                <el-row>
