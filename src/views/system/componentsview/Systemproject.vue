        ...
        <el-main>
          ...
          <div class="el_main_table_box" ref="el_main_table_box">
            <el-table
              ...
              <el-table-column prop="indexid" label="indexId" :resizable="false"></el-table-column>
              ...
              <el-table-column prop="itemsItemSamplesVolume" label="样品数量" :resizable="false">
                <template slot-scope="scope">
          ...
          <el-dialog
            ...
            <div slot="footer" class="dialog-footer">
              ...
              <el-button @click="closeBtnClick('ruleForm')">取 消</el-button>
            </div>
          </el-dialog>
          <!--编辑的对话框-->
          <el-dialog
            ...
            <div slot="footer" class="dialog-footer">
              ...
              <el-button @click="closeBtnClick('ruleForm1')">取 消</el-button>
            </div>
          </el-dialog>
          <!--查看的对话框-->
          <el-dialog
  ...
  export default {
    ...
    methods: {
      ...
      tableLocation() {
        ...
        this.$api.systemProject.readProjectTable(this.saveMsId, this.value2, value1).then(res => {
