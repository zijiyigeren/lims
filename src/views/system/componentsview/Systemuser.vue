            ...
            <div class="inquire">
              <el-form :inline="true" size="small" :model="formInline" class="demo-form-inline" label-width="82px">
                <div style="width: calc(100% - 55px);">
                  <el-form-item label="部门 :"  style="width: 19%;">
                    <el-select style="width:240px;" v-model="formInline.value" placeholder="请选择部门" :clearable="true">
                      <el-option v-for="item in findDepartmentList" :key="item.id" :label="item.org_name"
                                 :value="item.id"></el-option>
                    </el-select>
                  </el-form-item>
                  <el-form-item label="用户名 :" style="width: 19%;">
                    <el-input v-model.trim="formInline.loginid" placeholder="用户名" @keyup.enter.native="searchEnterFun"
                              clearable></el-input>
                  </el-form-item>
                  <el-form-item label="姓名 :" style="width: 19%;">
                    <el-input v-model.trim="formInline.name" placeholder="姓名" @keyup.enter.native="searchEnterFun"
                              clearable></el-input>
                  </el-form-item>
                </div>
