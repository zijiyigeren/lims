    ...
    <div class="sectlxtBg">
      <div class="inBoxs">
        <div class="inBoxsleft">
          ...
          <div class="incoupt">
            <label>任务号：</label>
            <el-input placeholder="请输入内容" v-model="tasknumber" clearable @keyup.enter.native="queryselect"  size="small"></el-input>
          </div>
          <div class="incoupt">
            <label>受检单位：</label>
            <el-input placeholder="请输入内容" v-model="examination" clearable @keyup.enter.native="queryselect"  size="small"></el-input>
          </div>
          ...
          <el-collapse-transition>
            <div v-show="show" class="showItem">
              <div class="incoupt">
                <label>规格型号：</label>
                <el-input placeholder="请输入内容" v-model="specification" clearable  size="small"
