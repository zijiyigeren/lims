    ...
    <section class="sectlxt">
        ...
        <div class="inBoxs">
            <div class="inBoxsleft">
                ...
                <div class="incoupt">
                    <label>样品名称：</label>
                    <el-input  placeholder="请输入内容" v-model="samplename"  size="small" clearable></el-input>
                </div>
                <div class="incoupt">
                    <label>任务号：</label>
                    <el-input  placeholder="请输入内容" v-model="tasknumber" clearable  size="small"  @keyup.enter.native="queryselect"></el-input>
                </div>
                <div class="incoupt">
                    <label>受检单位：</label>
                    <el-input  placeholder="请输入内容" v-model="examination" clearable  size="small"  @keyup.enter.native="queryselect"></el-input>
                </div>
