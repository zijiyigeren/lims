    ...
    <section class="sectlxt">
        ...
        <div class="inBoxs">
            <div class="inBoxsleft">
                ...
                <div class="incoupt">
                    <label>样品名称：</label>
                    <el-input  placeholder="请输入内容" v-model="samplename" clearable  size="small"></el-input>
                </div>

                <div class="incoupt">
                    <label>任务号：</label>
                    <el-input  placeholder="请输入内容" v-model="tasknumber"  size="small" clearable @keyup.enter.native="queryselect"></el-input>
                </div>
                <div class="incoupt">
                    <label>受检单位：</label>
                    <el-input  placeholder="请输入内容" v-model="examination"  size="small" clearable @keyup.enter.native="queryselect"></el-input>
                </div>
                <el-collapse-transition >
                    <div v-show="show" class="showItem">
                        ...
                        <div class="incoupt">
                            <label>规格型号：</label>
                            <el-input  placeholder="请输入内容" v-model="specification"  size="small" clearable @keyup.enter.native="queryselect"></el-input>
                        </div>
                        <div class="incoupt">
                            <label>下达日期 >= &nbsp;</label>
                            <el-date-picker
...
export default {
    ...
    methods:{
        ...
        reportingType(){
            this.$api.lxtinitial.approval().then(res =>{
                console.log(res)
                if(res.data.respCode == 0){
    ...
    watch:{
        reportValue(){
            if(this.reportValue==6){
              this.reportValue = "报告批准"
            }
        }
    }
}
...
.inBoxs{ width: 98.8%; display: flex;  flex-wrap:wrap; background-color: #fff; margin:5px auto 0; padding-bottom: 10px;}

.incoupt{ width: 20%; height: 40px; line-height: 40px; display: flex;  margin-top: 1%}
.incoupt label{ width: 100px; text-align: right;font-size: 14px;
    color: #606266;}
