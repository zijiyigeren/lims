...
<script>
import taskManage1 from '@/views/task/componentsview/Taskmanage.vue'
export default {
  ...
  computed: {
    newName() {
      return this.tinfo.staticyear
    },
    newName1() {
      return this.tinfo.paramPath
    },
    month() {
  ...
  created() {
    ...
    this.getDepartment();
    this.getCachetType();
    // if (this.tinfo.companyCheck == this.tinfo.consignor) {
    //   this.wtdw = false;
    // } else {
    //   this.wtdw = true;
    // }
