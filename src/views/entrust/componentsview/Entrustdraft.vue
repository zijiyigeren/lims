<template>
  ...
  <div class="box_cont">
    <div class="top">
      <div class="left">
        <el-form
          ...
          label-width="82px"
          :inline="true"
          style="width:calc(100% - 55px);display:flex;justify-content: space-between;"
        >
          <el-form-item label="任务号 : " placeholder="请输入" style="width:19%;">
            <el-input placeholder="请输入任务号" v-model="sizeForm.taskCode" clearable
                      @keyup.enter.native="searchEnterFun"></el-input>
          </el-form-item>
          <el-form-item label="受检单位 : " placeholder="请输入" style="width:19%;">
            <el-input placeholder="请输入受检单位" v-model="sizeForm.companyCheck" clearable
                      @keyup.enter.native="searchEnterFun"></el-input>
          </el-form-item>
          <el-form-item label="样品名称 : " placeholder="请输入" style="width:19%;">
            <el-input placeholder="请输入样品名称" v-model="sizeForm.sampleName" clearable
                      @keyup.enter.native="searchEnterFun"></el-input>
          </el-form-item>
          <el-form-item label="规格型号 : " placeholder="请输入" style="width:19%;">
            <el-input placeholder="请输入规格型号" v-model="sizeForm.sampleType" clearable
                      @keyup.enter.native="searchEnterFun"></el-input>
          </el-form-item>
          <el-form-item label="下达人 : " placeholder="请输入" style="width:19%;">
            <el-input placeholder="请输入下达人" v-model="sizeForm.commiterId" clearable
                      @keyup.enter.native="searchEnterFun"></el-input>
          </el-form-item>
        </el-form>
      </div>
    ...
    <div class="bottom">
      <div class="bottom-table">
        <el-table
          ...
          <el-table-column prop="commiterId" align="center" label="操作人" :resizable="false"></el-table-column>
    ...
    <el-dialog
      ...
      :fullscreen="true">
      <taskDetail ref="taskDetail" saveType="1"></taskDetail>
    </el-dialog>
    <!-- 绑定 -->
    <el-dialog
      :title="Binding"
  ...
  export default {
    ...
    methods: {
      ...
      handleDetails(index, row) {
        ...
        this.$api.draft.getDetail(row.id).then(res => {
