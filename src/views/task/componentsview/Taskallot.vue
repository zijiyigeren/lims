  ...
  <div class="taskallot_box" :style="{ padding: isComing != 0 ? '10px':'0'}">
    <div class="allot">
      <div class="allot_top" v-if="isComing != 0">
        <div style="display: flex;align-items: center;">
          <el-form :inline="true" :model="formLabelAlign"
            ...
            <div style="display: flex;justify-content: space-between;">
              <el-form-item style="width:19%">
                ...
                <el-input v-model="formLabelAlign.name" @keyup.enter.native="searchEnterFun"></el-input>
              </el-form-item>
              <el-form-item style="width:19%">
                <span slot="label" class="myLabel">受检单位 :</span>
                <el-input v-model="formLabelAlign.unit" @keyup.enter.native="searchEnterFun"></el-input>
              </el-form-item>
              <el-form-item style="width:19%">
                <span slot="label" class="myLabel">样品名称 :</span>
                <el-input v-model="formLabelAlign.sample_name" @keyup.enter.native="searchEnterFun"></el-input>
              </el-form-item>
              <el-form-item style="width:19%">
                <span slot="label" class="myLabel">规格型号 :</span>
                <el-input v-model="formLabelAlign.specifications" @keyup.enter.native="searchEnterFun"></el-input>
              </el-form-item>
              <el-form-item style="width:19%">
          ...
          <div style="min-width: 55px;">
            <el-button v-if="showbut==0" @click="clickshowbut(1)" type="text" style="color:#32AFF0;border: none;padding: 10px 0;">
              收起 <i class="el-icon-arrow-up"></i>
            </el-button>
            <el-button v-if="showbut!=0" @click="clickshowbut(0)" type="text" style="color:#32AFF0;border: none;padding: 10px 0;">
                ...
                <div>
                  <el-table ref="Table2" border v-loading="loading2"
                    ...
                    <el-table-column prop="orgName" label="主检人" align="center" :resizable="false">
                      <template slot-scope="scope">
                        <el-select size="mini" style="width:80%;" v-model="tableData2[scope.$index].orgName"
                          ...
                          <el-option v-for="(item,i) in arrs" :key="i" :label="item.loginName+'_'+item.name"
                    ...
                    <el-table-column type="expand" width="1" :resizable="false">
                      <template>
                        <!-- 三级弹出 -->
                        <el-table border :data="tableData3" v-loading="loading3" style="width: 100%" :header-cell-style="{
                                              'background-color': 'rgba(243,246,253,1)',
                                              'color': '#606266',
                                              'padding': '10px 0'
                                          }">
                          ...
                          <el-table-column prop="create_date" align="center" label="开始时间" :resizable="false"></el-table-column>
                          <el-table-column prop="end_date" align="center" label="结束时间" :resizable="false"></el-table-column>
                          <el-table-column prop="name" align="center" label="负责人" :resizable="false"></el-table-column>
                          <el-table-column prop="reason" align="center" label="处理意见" :resizable="false"></el-table-column>
                        </el-table>
                      </template>
                    </el-table-column>
                  </el-table>
      ...
      <el-dialog :title="dialogFormTitle" :visible.sync="dialogFormVisible"
                ...
                :fullscreen="true"
      >
        <taskDetail ref="taskDetail" saveType="2"></taskDetail>
      </el-dialog>
