...
const taskmanage = {
    ...
    apiFindWorkLog(params) { 
        return axios.get(`${base.systemgenre}/taskmanager/findWorkLog`, {params})
    },
    // 退回草稿
    apiContentDelete(params) { 
        return axios.get(`${base.systemgenre}/taskmanager/contentDelete`, {params})
    },
    // 退回
    apiJobTaskFindBackFlow() { 
        return axios.get(`${base.systemgenre}/job/task/findBackFlow/${7}`)
    },
    // 退回完成确定
    ...
    apiEditTaskInfo(params) { 
        return axios.post(`${base.systemgenre}/taskmanager/editTaskInfo?taskid=${params.taskid}`)
    },
    // 打开报告
    ...
    // },
    getdownloadpath(){
        return `${base.wang}/TaskReport/batchDownload`
    },
    //查看文件
    printXlsByTaskId(id){
